...
import charImage from '../images/ismark-2.png'
...
export class Ismark extends Component {
    render() {
        return (
            <div className='ismarkBackground'>
            <NavBar />
            <CharSideBar />
            <div className='playerCharacters'> 
                <div className='Title'>Ismark</div>
            </div>
            ...
            <Collapsible trigger="Cantrips" triggerClassName='semi-transparent-button-light' triggerOpenedClassName='semi-transparent-button-light'>
